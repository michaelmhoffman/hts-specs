...
\begin{savenotes}
  \begin{table}
    \begin{tabularx}{\textwidth}{r L}
      ...
      Float & Decimal string representation of 64-bit floating point number\footnote{\emph{IEEE Standard for Binary Floating-Point Arithmetic.} IEEE 754--1985, 1985} \\
